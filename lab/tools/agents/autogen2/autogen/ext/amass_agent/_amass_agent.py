...
AMASS_TOOL_DESCRIPTION = "A helpful and general-purpose security AI assistant that has strong skill to run amass tool."

AMASS_TOOL_SYSTEM_MESSAGE = """You are a helpful assistant to run OSINT security tools such as amass
...
class AmassToolAgent(AssistantAgent):
    ...
    def __init__(
        ...
        super().__init__(
            name,
            model_client,
            description=AMASS_TOOL_DESCRIPTION,
            system_message=AMASS_TOOL_SYSTEM_MESSAGE,
        )